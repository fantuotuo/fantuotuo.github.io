(function (global, factory) {
	...
	var CAMERA_WIDTH = _GLB2.default.CAMERA_WIDTH;
	var W = _GLB2.default.W;
	var H = _GLB2.default.H;
	var W_B = 150 * CAMERA_WIDTH / W;
	var H_B = 130 * CAMERA_WIDTH / W;
	var INTER_X = 0.2;
	var INTER_Z = 0.5;
	...
	function Block(index) {
		...
		var mesh = _GLB2.default.res["block"].clone();
		this.add(mesh);
		...
		function getTexture(str, i, geo, mat) {
			...
			geo.faceVertexUvs[0] = [];
			var bricks = [new THREE.Vector2(x0, y1), new THREE.Vector2(x0, y0), new THREE.Vector2(x1, y0), new THREE.Vector2(x1, y1)];
